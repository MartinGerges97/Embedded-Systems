...
int Return_Array(int Lower_value, int Upper_value)
{
	...
	int array_size = Upper_value - Lower_value -1;
	for(int i = 0;i<array_size;i++)
	{
		array[i] = Upper_value-1-i;
	}
	return array_size;
